...
func (g16 *G16_two_commit) Export() error {
	var ProofPath, VKeyPath string

	switch g16.proof.(type) {
	case *groth16_bls12381.Proof:
		ProofPath, VKeyPath = ProofPathG16_two_commit_BLS12381, VKeyPathG16_two_commit_BLS12381
	case *groth16_bn254.Proof:
		ProofPath, VKeyPath = ProofPathG16_two_commit_BN254, VKeyPathG16_two_commit_BN254
	default:
...
func (g16 *G16_two_commit) Compile(ScalarField *big.Int) error {
	var err error
...
func (g16 *G16_two_commit) Setup() error {
	var err error
...
func (g16 *G16_two_commit) Prove(ScalarField *big.Int) error {
	var err error
...
func (g16 *G16_two_commit) Verify() error {
...
func (g16 *G16_two_commit) getWitness(ScalarField *big.Int) error {
	var err error
